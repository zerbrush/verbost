...
const nextConfig = {
  ...
  env: {
    ...
    ADMIN_EMAIL: process.env.ADMIN_EMAIL || 'hank.zerbe@verbost.ai',
    SENDGRID_FROM_EMAIL: process.env.SENDGRID_FROM_EMAIL || 'report@verbost.ai',
    SENDGRID_FROM_NAME: process.env.SENDGRID_FROM_NAME || 'Verbost AI',
    SENGRID_ADMIN_EMAIL: process.env.SENGRID_ADMIN_EMAIL || 'hank.zerbe@verbost.ai',
